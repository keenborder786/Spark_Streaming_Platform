...
delta_lake_tables_config = json.loads(os.environ['DELTA_LAKE_TABLE_CONFIG'])['Delta_Lake_Tables']
delta_lake_schemas = json.loads(os.environ['DELTA_LAKE_SCHEMA'])['Delta_Lake_Tables']
...
for table in delta_lake_schemas:
    final_schemas[table] = {}
    table_write_schema,table_fields_map,table_cdc_delta_schema,debeziumTableEventSchema = parse_json(delta_lake_schemas[table]['fields'] , spark_to_python_types , debeziumSourceSchema)
