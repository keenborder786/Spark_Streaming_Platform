...
def bindFunction(table_name:str , spark_processor:SparkProcessing , 
                delta_lake_builder , cdc_schema:StructType() , 
                fields_map:Dict[str,str]) -> Callable:
    """
    ...
    def func(micro_df:pyspark.sql.DataFrame , batch_id:int):
        ...
        print(f"===========Processing micro-batch {batch_id} for {table_name} Table===========")
